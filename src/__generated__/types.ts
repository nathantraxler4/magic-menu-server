...
export type Query = {
    __typename?: 'Query';
    generateMenu: Menu;
    generateMenuFromPrompt: Scalars['String']['output'];
    menus: Array<Menu>;
...
> = {
    addRecipes?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationAddRecipesArgs, 'recipes'>
    >;
};
...
> = {
    generateMenu?: Resolver<
        ResolversTypes['Menu'],
        ParentType,
        ContextType,
        RequireFields<QueryGenerateMenuArgs, 'recipes'>
    >;
    generateMenuFromPrompt?: Resolver<
        ResolversTypes['String'],
        ParentType,
        ContextType,
        RequireFields<QueryGenerateMenuFromPromptArgs, 'prompt'>
    >;
